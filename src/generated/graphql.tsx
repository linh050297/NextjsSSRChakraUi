...
export type Query = {
  ...
  post?: Maybe<Post>;
  searchPostByTitle?: Maybe<Array<Post>>;
  hello: Scalars['String'];
  me?: Maybe<User>;
  getAllUser: Array<User>;
  getUser?: Maybe<User>;
  findByEmail?: Maybe<Array<User>>;
};
...
export type QuerySearchPostByTitleArgs = {
...
export type PostSnippetFragment = (
  { __typename?: 'Post' }
  & Pick<Post, 'id' | 'createdAt' | 'text' | 'title' | 'creatorId' | 'textSnippet' | 'titleSnippet' | 'points'>
);

export type RegularUserFragment = (
  { __typename?: 'User' }
  & Pick<User, 'id' | 'email' | 'createdAt' | 'username' | 'updatedAt'>
);
...
export type CreatePostMutation = (
  ...
  & { createPost: (
    ...
    & { errors?: Maybe<Array<(
      ...
      { __typename?: 'Post' }
      & Pick<Post, 'id' | 'createdAt' | 'text' | 'points' | 'updatedAt' | 'title' | 'creatorId'>
    )> }
  ) }
);
...
export type PostQuery = (
  ...
  & { post?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'createdAt' | 'updatedAt' | 'text' | 'title' | 'creatorId' | 'titleSnippet' | 'points'>
    & { creator: (
      { __typename?: 'User' }
